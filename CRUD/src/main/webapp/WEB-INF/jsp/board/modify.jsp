...
<body style="background-color: #242424; color: white">
    <div class="container">
        <ul class="nav justify-content-center">
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="/board/lists">게시판</a>
            </li>
            ...
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        <th scope="row">글내용</th>
                        <td>
                            <textarea class="summernote" style="width: 100%; height: 300px" class="form-control" rows="3" name="content">${board.content}</textarea>
                        </td>
                    </tr>
                    <tr>
                        <th>업로드</th>
                        <td colspan="2"><input type="file" name="uploadFile" />${board.filepath}</td>
                    </tr>
                </tbody>
            </table>
            <input type ="hidden" name ="content_id" value ="${board.content_id}">
